...
#define cspeed  3e10; //the speed of light is 3e10 mm/second.
...
public:
    ...
    virtual void setDistTOF(float dist){dist_TOF = dist;}
    virtual float getDistTOF() const{return 0.5*dist_TOF*cspeed;}
private:
    Point3D startPt;
    Point3D endPt;
